...
from src.shapes import createCapsule, createBox, createSphere
...
#        self.lowerLeg = createCapsule(self.render, lowerLegDiameter*4, self.lowerLegLength+self.footHeight*2)
        ...
        self.lowerLeg = createSphere(self.render, self.lowerLegLength+self.footHeight*3)
#        self.lowerLeg = createBox(self.render, lowerLegDiameter*4, lowerLegDiameter*4, self.lowerLegLength+self.footHeight*2)
...
#        self.foot.node().setAngularFactor(Vec3(0.1,0.1,1))
        ...
        self.heel.setDebugDrawSize(0.5)

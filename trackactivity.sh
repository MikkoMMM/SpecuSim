...
while true; do
	...
	diff ../specusim-activity.txt ../specusim-activity2.txt | grep "^>" | cut -c28- | grep -v ".pyc\$" | grep -v " src\$" >> ../file-activity.txt
	diff ../specusim-plan-activity.txt ../specusim-plan-activity2.txt | grep "^>" | cut -c28- | grep -v ".pyc\$" | grep -v " src\$" >> ../file-activity.txt
	diff ../specusim-misc-activity.txt ../specusim-misc-activity2.txt | grep "^>" | cut -c28- | grep -v ".pyc\$" | grep -v " src\$" >> ../file-activity.txt
